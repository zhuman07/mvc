                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-8">
                            <div class="shop-menu pull-right">
                                <ul class="nav navbar-nav">
                                    <?php if(isset($user['role']) == 'admin'): ?>
                                    <li><a href="/admin/"><i class="fa fa-lock"></i> Админпанель</a></li>
                                    <?php else: endif; ?> 
                                    <li><a href="/cart/"><i class="fa fa-shopping-cart"></i> Корзина <span id="cart-count">(<?php echo Cart::countItem(); ?>)</span></a></li>
                                    <?php if(User::isGuest()): ?>
                                    <li><a href="/user/registr"><i class="fa fa-sign-in"></i> Регистрация</a></li>
